...
# Last modified:
#
# File name: test_genome_table.sql
#
# The test_genome_table.sql is simply a concatenation of 
#
# - table.sql from /ensembl/sql 
# - table.sql from /ensembl/sql
# 
# Both table.sql's were taken from the main trunk
#
#
# MySQL dump 5.13
#
...
########################################################
# end of table.sql from ensembl/sql
########################################################


########################################################
# start of table.sql from ensembl-pipeline/sql
########################################################
